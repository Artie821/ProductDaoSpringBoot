...
<section style="width: 100%">
    ...
    <div class="row">
        <div class="container p-3 my-3 border shadow p-1 mb-1 bg-white rounded">
            ...
            <div class="container p-3 my-3 border shadow p-1 mb-1 bg-white rounded">
                <form method="post"  action="/addCategoryAdmin/">
                    <div class="form-group">
                        <label >Nazwa kategorii:</label>

                        <input name="categoryName" class="form-control" placeholder="Nazwa kategorii" required/>
                        <cite title="Source Title">To pole jest wymagane, wprowadź nazwę dodowanej katgorii.</cite>
                    </div>
