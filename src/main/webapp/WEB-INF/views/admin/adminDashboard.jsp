...
<section style="width: 100%">
    <div class="row">
        <div class="container p-3 my-3 border shadow p-1 mb-1 bg-white rounded">
            <h3 style="float:left">
                    <a href="/dashboard//" class="btn btn-outline-success active btn-large" >Zarządzaj kategoriami</a>
                ...
                <c:forEach items="${categories}" var="category" >
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/editCategoryAdmin/${category.categoryName}"  class="btn btn-outline-success btn-sm">EDYTUJ</a>


                            <a href="/removeCategoryAdmin/${category.categoryName}" class="btn btn-outline-danger btn-sm" value="">USUŃ</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
    ...
    <div class="row">
        <div class="container p-3 my-3 border shadow p-1 mb-1 bg-white rounded">
            <a href="/addCategoryAdmin/" class="btn btn-outline-success btn-lg">DODAJ KATEGORIĘ</a>
        </div>
    </div>
</section>
