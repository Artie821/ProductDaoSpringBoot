...
<section style="width: 100%">
            ...
            <table id="table" class="table table-striped">
                ...
                <c:forEach items="${categories}" var="category" >
                    <tr>
                        ...
                        <td>
                            <a href="/admin/editCategoryAdmin/${category.id}"  class="btn btn-outline-success btn-sm">EDYTUJ</a>
                            <a href="/admin/removeCategoryAdmin/${category.id}" class="btn btn-outline-dark btn-sm" value="">ZMIEŃ STATUS</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
    ...
    <div class="row">
        <div class="container p-3 my-3 border shadow p-1 mb-1 bg-white rounded">
            <a href="/admin/addCategoryAdmin/" class="btn btn-outline-success btn-lg">DODAJ KATEGORIĘ</a>
        </div>
    </div>
</section>
