...
<section style="width: 99%">
    <div class="row">
        <div class="container p-3 my-3 border shadow p-1 mb-1 bg-white rounded">
            <h3 style="float: left"> Zaloguj się </h3>
            ...
            <section class="login-page">
                <c:if test="${param.success}">
                    <div class="alert alert-success alert-dismissable">
                        ...
                        Gratulacje! konto zostało utworzone!
                ...
                <c:if test="${param.error}">
                    <div class="alert alert-danger alert-dismissable">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                        Nieprawidłowy login lub hasło, konto jest zablokowane, lub nie jest aktywowane!
                    </div>
                </c:if>
                <form class="form-signin" method="post">
                <div class="form-group">
                    <input type="text" id="username" placeholder="Nazwa użytkownika" required autofocus
                           name="username" class="form-control"/>
                </div>
                    <div class="form-group">
                        <input type="password" id="password" placeholder="Hasło" required name="password" class="form-control"/>
                    </div>
